package com.baymax.discordBot.assets.memes;
...
public class ImageURL {
    ...
    private static List<String> dabPictures = new ArrayList<>(Arrays.asList(
            "https://scontent-atl3-1.cdninstagram.com/vp/3ce0c5ec315aedfa4a21dffbb52ee682/5C4661F6/t51.2885-15/e35/38626126_2171367539767391_4091908689718411264_n.jpg",
            "https://i.redd.it/vfujmtk22z401.jpg",
            "https://i.ytimg.com/vi/H3ztJs4uSDY/hqdefault.jpg"
    ));

    private static List<String> whipPictures = new ArrayList<>(Arrays.asList(
            "https://thumbs.gfycat.com/PoisedDecisiveIndianabat-mobile.jpg",
            "https://media.tenor.com/images/9db1eeb4be951275afad6ce729456e31/tenor.gif"
    ));

    private static List<String> cursedImages = new ArrayList<>(Arrays.asList(
            "",
            "",
            "",
            "",
    ...
    public static String getDabPictures() {
        int randomIndex = random.nextInt(dabPictures.size());
        Collections.shuffle(dabPictures);
        return dabPictures.get(randomIndex);
    }

    public static String getWhipPictures() {
        int randomIndex = random.nextInt(whipPictures.size());
        Collections.shuffle(whipPictures);
        return whipPictures.get(randomIndex);
    }

    public static String getCursedImages() {
        int randomIndex = random.nextInt(cursedImages.size());
        Collections.shuffle(cursedImages);
        return cursedImages.get(randomIndex);
    }
