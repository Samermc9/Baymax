...
public class MessageGifURL {
    public static final String kimchiSlap = "https://giphy.com/gifs/slap-kimchi-13dRJkj5wgKq9q";

    private static List<String> slapList = new ArrayList<>(Arrays.asList(kimchiSlap,
    ...
    private static List<String> hugList = new ArrayList<>(Arrays.asList(
            "https://cdn.discordapp.com/attachments/386194586285899781/483310567944355870/image0.gif",
            "https://cdn.discordapp.com/attachments/386194586285899781/483310567944355870/image0.gif",
            "https://cdn.discordapp.com/attachments/386194586285899781/483310567944355870/image0.gif"));


    private static List<String> killList = new ArrayList<>(Arrays.asList(
